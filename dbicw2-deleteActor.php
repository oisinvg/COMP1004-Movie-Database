<html>
  ...
  <body>
    ...
    <div id="main"> 
      ...
      <div id="content">
        <h1>Delete Actor</h1>
        <p style="text-align: left;"><a href="dbicw2-deleteActor.php">Delete a movie</a></p>
        ...
        $query = "SELECT actName,actID FROM Actor;"; //assemble query to fetch all movies on db
        ...
        <table id="search">
          ...
          while ($stmt->fetch()) {
            $dellink = "$ID";
            echo "<tr><td>$Actor</td>" . 
            "<td><a href=\"http://avon.cs.nott.ac.uk/~psyog2/dbicw2-deleteActor2.php?del=$dellink\"><img src=\"dbicw2-delete.png\" width=\"30\" height=\"30\"></a></td></tr>";
          }
          ?>
        </table>
      </div>
