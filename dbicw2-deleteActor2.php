  ...
  <body>
    ...
    <div id="main"> 
      ...
      <div id="content">
        ...
        $query = "SELECT actName, actID FROM Actor WHERE actID = $del LIMIT 1;"; //select one row to ask about deletion
        ...
        <table align="center" style="text-align: center">
          <tr>
            <td colspan=2>Are you sure you want to<br>delete this actor?</td>
        </tr>
        <tr>
            <td><form action="dbicw2-deleteActor3.php"><input type="submit" value="Yes"></form></td>
            <td><form action="dbicw2-deleteActor.php"><input type="submit" value="Cancel"></form></td>
          </tr>
        </table>
